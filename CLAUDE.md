...
- **Pendiente módulo Contratos:** probar end-to-end en producción con un contrato real de Sargo; módulo admin de plantillas para Felipe (aprobar/cargar); anexos (renovaciones) como gestión aparte; Fase 3 = alta en nómina + Excel compartido (Google Sheets) + alertas vencimiento plazo fijo (Art. 159 N°4 CT).
