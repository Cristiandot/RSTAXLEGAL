...
- **Pendiente módulo Contratos:** probar end-to-end con un contrato real de Sargo; **anexos** (renovaciones/cambio jornada — plantillas ya registradas, falta el formulario); **enviar al cliente por correo con un click** (vía Resend); módulo admin de plantillas para Felipe; Fase 3 = alta en nómina + Excel compartido + alertas vencimiento plazo fijo (Art. 159 N°4 CT). La col `clientes.form_solicitud_url` (MS Forms) quedó sin uso.
