...
- **Pendiente:** decidir almacenamiento de plantillas (repo vs Storage), registrarlas en `plantillas_contrato`, construir formulario de solicitud + motor de generación .docx + flujo de revisión.
